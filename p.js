...
const stage = new Konva.Stage({
    container: 'container',
    width: typeof window !== 'undefined' ? window.innerWidth : 800, // Fallback width for Node.js environment
    height: typeof window !== 'undefined' ? window.innerHeight : 600, // Fallback height for Node.js environment
});
