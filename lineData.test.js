...
describe('updatelineData function', () => {
    it('should update length and angle based on input points', () => {
        ...
        expect(lengthElement.textContent).to.equal('0.85'); // Replace with the expected value
        expect(angleElement.textContent).to.equal('65'); // Replace with the expected value
    });
});
